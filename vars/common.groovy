...
def artifactpush() {
    ...
    sh "curl -v -u ${NEXUS_USER}:${NEXUS_PASS} --upload-file ${component}-${TAG_NAME}.zip http://172.31.10.252:8081/repository/maven-releases/${component}/${component}-${TAG_NAME}.zip"
